...
namespace VillageSmartPOS.Models
{
    public class BillItem
    {
        ...
        public decimal Savings => MarkedTotal - Total;
        public string SavingsText => MarkedPrice > Price ? $"Save {_billSettings.CurrencySymbol} {Savings:F2}" : "";
        
        // Formatted properties for display
        public string FormattedMarkedPrice => $"{MarkedPrice:F2}";
